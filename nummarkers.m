...
%------------------------
% if you load a figure that you have saved before, you can follow these
% steps:
%   1. open the figure 
%   2. deactivate the legend
%     3. save the file
%     4. write in the command line the following codes
%         a. open('your file.fig')
%         b. h=gcf
%         c. axesObjs = get(h, 'Children')
%         d. dataObjs = get(axesObjs, 'Children')
%         e. nummarkers(dataObjs,number of marker points you want,1)
%         f. legend(dataObjs) % this corrects the legend for you
%     Have fun!
% Hamed Ahmadi, 12 Feb 2014
